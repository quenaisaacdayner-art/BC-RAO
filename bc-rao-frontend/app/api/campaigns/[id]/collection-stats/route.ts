...
/**
 * GET /api/campaigns/[id]/collection-stats - Fetch collection statistics
 *
 * Validates user ownership and proxies to FastAPI backend
 * Returns funnel stats and post counts by archetype/subreddit
 */
export async function GET(
  ...
  const backendUrl = `${apiUrl}/collection/campaigns/${id}/stats`;
