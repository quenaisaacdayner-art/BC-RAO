...
/**
 * SSE Proxy Route: Streams analysis progress from FastAPI backend
 * GET /api/analysis/[taskId]/progress
 *
 * Proxies Server-Sent Events from backend /v1/analysis/{task_id}/progress
...
export async function GET(
  ...
  const backendUrl = `${apiUrl}/analysis/${taskId}/progress`;
